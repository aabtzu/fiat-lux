            ...
            <section>
              ...
              <ul className="space-y-2 text-gray-600">
                <li className="flex items-start gap-2">
                  ...
                  <span><strong>Schedules</strong> like weekly calendars that show your time at a glance</span>
                </li>
                <li className="flex items-start gap-2">
                  ...
                  <span><strong>Invoices</strong> with clear breakdowns of charges and totals</span>
                </li>
                <li className="flex items-start gap-2">
                  ...
                  <span><strong>Healthcare bills</strong> that demystify medical costs and coverage</span>
                </li>
                <li className="flex items-start gap-2">
                  ...
                  <span><strong>And many more...</strong> any document that needs clarity</span>
                </li>
              </ul>
            </section>
